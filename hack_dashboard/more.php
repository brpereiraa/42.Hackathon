                ...
                <div class="flex w-4/5">
                    <div class="w-3/4 h-auto my-auto">
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Name:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4 ">
                                <?= $row["name"] ?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Store:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["store"]?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Location:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["loc"] == "es" ? "Espanha" : "Portugal" ?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Year:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["year"] ?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Price:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["price"] . $row["curr"] ?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Discounted:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["disc"] ?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Scraping Date:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["date"] ?>
                            </p>
                        </div>
                        <div class="m-auto flex w-full">
                            <p class="my-auto me-6 text-lg py-3">Capacity:</p>
                            <p class="my-auto border-b-2 border-stone-800 my-8 text-lg w-3/4">
                                <?= $row["capacity"] ?>
                            </p>
                        </div>
